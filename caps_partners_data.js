...
//
// SNAPSHOT TIMESTAMP  : 2026-08-27T12:34:41Z
// LAST HUBSPOT CHANGE : 2026-08-25T18:19:14.544Z
// TOTAL RECORDS       : 103
//   Completed  (3)    : 44
//   In Process (2)    : 16
//   Applied    (1)    : 36
//   Rejected   (4)    : 7
//
// DELTA vs Jun 12 2026 baseline (96 partners):
//   7 new partners: SOPHOS, Barracuda, HPE, Asset Panda, Lightcast, AbsenseSoft, Jotform
//   2 stage changes: ArcGIS (Applied->In Process), Industrial Defender (Completed->In Process)
// ═══════════════════════════════════════════════════════════════

const CAPS_DATA_SNAPSHOT_TS  = "2026-08-27T12:34:41Z";
const CAPS_HS_LAST_MODIFIED  = "2026-08-25T18:19:14.544Z";
const CAPS_TOTAL_RECORDS     = 103;
...
const HS_PARTNERS = [
  {
    ...
    "stage": "3",
    "cat": "Cybersecurity",
    "desc": "Sophos provides cybersecurity solutions including endpoint protection, firewall, email security, and managed detection and response (MDR) for enterprise and government environments.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Cybersecurity",
    "desc": "Barracuda provides cloud-first security solutions including email protection, network security, application security, and data protection for businesses and government organizations.",
    "solutions": [
  ...
  },
  {
    ...
    "desc": "HPE provides enterprise IT infrastructure including servers, storage, networking, and hybrid cloud solutions. Its GreenLake platform delivers cloud services on-premises with flexible consumption models widely adopted in government and enterprise environments.",
    "solutions": [
  ...
  },
  {
    ...
    "desc": "Asset Panda is a cloud-based asset tracking and management platform that enables organizations to track, manage, and audit physical and IT assets through a customizable, mobile-friendly interface.",
    "solutions": [
      "Asset Tracking",
      "IT Asset Management",
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Data & Analytics",
    "desc": "Lightcast (formerly Emsi Burning Glass) provides labor market data, workforce analytics, and economic impact insights used by government agencies, universities, and workforce development organizations to understand employment trends and skill gaps.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "HCM & HR",
    "desc": "AbsenseSoft provides leave management and absence tracking software that helps organizations manage employee leave requests, track absences, and ensure compliance with leave policies and regulations.",
    "solutions": [
  ...
  },
  {
    ...
    "desc": "Jotform is a cloud-based form builder and data collection platform enabling organizations to create online forms, surveys, and workflows without coding. It is used by government agencies for citizen intake, applications, and internal approvals.",
    "solutions": [
      "Online Forms & Surveys",
      "Citizen Intake Forms",
      "Workflow Automation",
      "E-Signatures",
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Digital Government",
    "desc": "Smart Communications provides a cloud-based customer communications management (CCM) platform enabling government agencies to manage complex, high-volume outbound communications across digital and print channels.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Cybersecurity",
    "desc": "Netskope provides a Security Service Edge (SSE) and SASE platform protecting data and users accessing cloud applications, the web, and private applications. It specializes in cloud-native DLP, CASB, and Zero Trust Network Access.",
    "solutions": [
      "Zero Trust Network Access (ZTNA)",
      "SASE Platform",
  ...
  },
  {
    ...
    "desc": "Infor provides industry-specific cloud ERP solutions for government, healthcare, and public services. Its CloudSuite Public Sector and Lawson platforms are used by state and local governments for finance, HR, supply chain, and asset management.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Cybersecurity",
    "desc": "CyberArk is the industry leader in Privileged Access Management, helping organizations secure and monitor privileged accounts, credentials, and access across on-premise and cloud environments. FedRAMP authorized and a core Zero Trust component.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Healthcare IT",
    "desc": "Netsmart provides electronic health records (EHR), care coordination, and analytics platforms specifically built for behavioral health, addiction treatment, and human services organizations.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Cybersecurity",
    "desc": "Okta is a leading cloud-based identity and access management (IAM) platform providing Single Sign-On (SSO), Multi-Factor Authentication (MFA), and identity governance. FedRAMP authorized and widely specified in government Zero Trust RFPs.",
    "solutions": [
      "Single Sign-On (SSO)",
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Digital Government",
    "desc": "DocuSign is the global standard for electronic signatures and digital agreement management. FedRAMP authorized and used extensively across federal, state, and local agencies for contracts, procurement approvals, and citizen-facing forms.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Cybersecurity",
    "desc": "Rapid7 provides cloud-based vulnerability management, threat detection, and incident response solutions. Its InsightVM platform is one of the most widely deployed vulnerability scanners in enterprise and government environments.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "ERP & Enterprise Apps",
    "desc": "Deltek provides ERP and project management software built specifically for government contractors. Its Costpoint and Vantagepoint platforms handle project accounting, billing, compliance, and contract management.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Cloud & Infrastructure",
    "desc": "GCP is Google's enterprise cloud platform offering compute, storage, data analytics, and AI/ML services with FedRAMP-authorized government cloud options including Vertex AI and Gemini capabilities.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Cybersecurity",
    "desc": "Zscaler is a cloud-native cybersecurity leader in Zero Trust Network Access (ZTNA) and SASE. It replaces traditional VPNs by routing all traffic through its cloud security platform, ensuring users connect directly to applications securely.",
    "solutions": [
      "Zero Trust Network Access (ZTNA)",
      "SASE Platform",
  ...
  },
  {
    ...
    "stage": "2",
    "cat": "Cybersecurity",
    "desc": "Industrial Defender provides cybersecurity solutions for operational technology (OT) and industrial control systems (ICS), helping critical infrastructure organizations achieve visibility, compliance, and security.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "ITSM & Asset Management",
    "desc": "FMX provides a cloud-based facilities and maintenance management platform for education, government, and property management organizations. It simplifies work order management, preventive maintenance, and asset tracking.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "1",
    "cat": "Cybersecurity",
    "desc": "Huntress is a managed cybersecurity platform providing threat detection, endpoint protection, and managed security operations specifically designed for SMB and MSP-served environments, focusing on ransomware and persistent threats.",
    "solutions": [
  ...
  },
  {
    ...
    "stage": "3",
    "cat": "Cloud & Infrastructure",
    "desc": "WP Engine provides managed WordPress hosting and digital experience solutions offering secure, scalable, and high-performance hosting.",
    "solutions": [
